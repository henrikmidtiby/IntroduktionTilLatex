...
\subsection{Fordele og ulemper ved \LaTeX{}}
\frame
{
...
\frame
{
	...
	\begin{itemize}
		\item MikTeX, \url{http://miktex.org/2.7/Setup.aspx}
	\end{itemize}

	Editorer (det program du bruger til at rette i latex dokumenter)
	\begin{itemize}
		\item	TexnicCenter, \url{http://www.toolscenter.org/downloads.html}
		\item 	Texmaker, \url{http://www.xm1math.net/texmaker/download.html}
\end{itemize}
}
...
\frame {
	\frametitle{Tabeller}
	\lstinputlisting{examples/10.tex}
}
...
\frame{
	...
	Mappe struktur for et lille latex dokument (alt i den samme mappe)
	\begin{itemize}
		\item	project.tex
		\item	vandstraaler.jpg
	\end{itemize}

	Min mappe struktur for et latex dokument (undermapper til billeder m.m.)
	\begin{itemize}
		\item	project.tex
		\item	pic/vandstraaler.jpg
	\end{itemize}
...
\includepdf[pages={1, 2, 3, 4}, nup=2x1, frame, delta=0.5cm 0.5cm, scale=0.9]
